...
OUTPUT = Path("lead-output/euro-spain-italy-map.html")
...
<head>
  ...
  <title>Euro Lead Map Command Center</title>
  <style>
    :root {{
      --bg: #020617;
...
<body>
  <div class="app">
    <div class="viewport">
      ...
      <div class="hud">
        <div class="title">
          <h1>Euro Lead Map Command Center</h1>
          <div>Spain/Italy source-market leads · drag pan · button zoom · click a point</div>
        </div>
        <div class="controls">
